      ...
      <div className="max-w-xl mx-auto mb-8">
        ...
        <AnimatePresence>
          {searchQuery.length >= 2 && (
            ...
            >
              <div className="mt-4 bg-white rounded-sm shadow-medical-lg border border-medical-surface-200 max-h-96 overflow-y-auto">
                      ...
                      >
                        <div className="flex justify-between items-start gap-4">
                          <div className="flex-1 min-w-0">
                            <p className="text-medical-primary-900 font-medium truncate">
                              {locale === 'ua' ? result.serviceName : result.serviceNameEn}
                            </p>
                            <p className="text-sm text-medical-text-tertiary mt-0.5 truncate">
